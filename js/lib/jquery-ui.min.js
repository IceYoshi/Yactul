...
-1!==this.className.indexOf("ui-datepicker-next")&&d(this).removeClass("ui-datepicker-next-hover")}).on("mouseover","button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a",T)}function T(){d.datepicker._isDisabledDatepicker(F.inline?F.dpDiv.parent()[0]:F.input[0])||(d(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),d(this).addClass("ui-state-hover"),-1!==this.className.indexOf("ui-datepicker-prev")&&d(this).addClass("ui-datepicker-prev-hover"),
-1!==this.className.indexOf("ui-datepicker-next")&&d(this).addClass("ui-datepicker-next-hover"))}function K(a,b){d.extend(a,b);for(var c in b)null==b[c]&&(a[c]=b[c]);return a}function E(a){return function(){var b=this.element.val();a.apply(this,arguments);this._refresh();b!==this.element.val()&&this._trigger("change")}}d.ui=d.ui||{};d.ui.version="1.12.0";var W=0,U=Array.prototype.slice;d.cleanData=function(a){return function(b){var c,f,e;for(e=0;null!=(f=b[e]);e++)try{(c=d._data(f,"events"))&&c.remove&&
...
f?(d.each(f._childConstructors,function(a,b){var c=b.prototype;d.widget(c.namespace+"."+c.widgetName,e,b._proto)}),delete f._childConstructors):b._childConstructors.push(e);d.widget.bridge(a,e);return e};d.widget.extend=function(a){for(var b=U.call(arguments,1),c=0,f=b.length,e,g;c<f;c++)for(e in b[c])g=b[c][e],b[c].hasOwnProperty(e)&&void 0!==g&&(d.isPlainObject(g)?a[e]=d.isPlainObject(a[e])?d.widget.extend({},a[e],g):d.widget.extend({},g):a[e]=g);return a};d.widget.bridge=function(a,b){var c=b.prototype.widgetFullName||
a;d.fn[a]=function(f){var e="string"===typeof f,g=U.call(arguments,1),h=this;e?this.each(function(){var b,e=d.data(this,c);if("instance"===f)return h=e,!1;if(!e)return d.error("cannot call methods on "+a+" prior to initialization; attempted to call method '"+f+"'");if(!d.isFunction(e[f])||"_"===f.charAt(0))return d.error("no such method '"+f+"' for "+a+" widget instance");b=e[f].apply(e,g);if(b!==e&&void 0!==b)return h=b&&b.jquery?h.pushStack(b.get()):b,!1}):(g.length&&(f=d.widget.extend.apply(null,
[f].concat(g))),this.each(function(){var a=d.data(this,c);a?(a.option(f||{}),a._init&&a._init()):d.data(this,c,new b(f,this))}));return h}};d.Widget=function(){};d.Widget._childConstructors=[];d.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",defaultElement:"<div>",options:{classes:{},disabled:!1,create:null},_createWidget:function(a,b){b=d(b||this.defaultElement||this)[0];this.element=d(b);this.uuid=W++;this.eventNamespace="."+this.widgetName+this.uuid;this.bindings=d();this.hoverable=
...
this._init()},_getCreateOptions:function(){return{}},_getCreateEventData:d.noop,_create:d.noop,_init:d.noop,destroy:function(){var a=this;this._destroy();d.each(this.classesElementLookup,function(b,c){a._removeClass(c,b)});this.element.off(this.eventNamespace).removeData(this.widgetFullName);this.widget().off(this.eventNamespace).removeAttr("aria-disabled");this.bindings.off(this.eventNamespace)},_destroy:d.noop,widget:function(){return this.element},option:function(a,b){var c=a,f,e,g;if(0===arguments.length)return d.widget.extend({},
this.options);if("string"===typeof a)if(c={},f=a.split("."),a=f.shift(),f.length){e=c[a]=d.widget.extend({},this.options[a]);for(g=0;g<f.length-1;g++)e[f[g]]=e[f[g]]||{},e=e[f[g]];a=f.pop();if(1===arguments.length)return void 0===e[a]?null:e[a];e[a]=b}else{if(1===arguments.length)return void 0===this.options[a]?null:this.options[a];c[a]=b}this._setOptions(c);return this},_setOptions:function(a){for(var b in a)this._setOption(b,a[b]);return this},_setOption:function(a,b){"classes"===a&&this._setOptionClasses(b);
this.options[a]=b;"disabled"===a&&this._setOptionDisabled(b);return this},_setOptionClasses:function(a){var b,c,f;for(b in a)f=this.classesElementLookup[b],a[b]!==this.options.classes[b]&&f&&f.length&&(c=d(f.get()),this._removeClass(f,b),c.addClass(this._classes({element:c,keys:b,classes:a,add:!0})))},_setOptionDisabled:function(a){this._toggleClass(this.widget(),this.widgetFullName+"-disabled",null,!!a);a&&(this._removeClass(this.hoverable,null,"ui-state-hover"),this._removeClass(this.focusable,
...
b(a.keys.match(/\S+/g)||[],!0);a.extra&&b(a.extra.match(/\S+/g)||[]);return c.join(" ")},_removeClass:function(a,b,c){return this._toggleClass(a,b,c,!1)},_addClass:function(a,b,c){return this._toggleClass(a,b,c,!0)},_toggleClass:function(a,b,c,d){d="boolean"===typeof d?d:c;var e="string"===typeof a||null===a;a={extra:e?b:c,keys:e?a:b,element:e?this.element:a,add:d};a.element.toggleClass(this._classes(a),d);return this},_on:function(a,b,c){var f,e=this;"boolean"!==typeof a&&(c=b,b=a,a=!1);c?(b=f=d(b),
this.bindings=this.bindings.add(b)):(c=b,b=this.element,f=this.widget());d.each(c,function(c,h){function k(){if(a||!0!==e.options.disabled&&!d(this).hasClass("ui-state-disabled"))return("string"===typeof h?e[h]:h).apply(e,arguments)}"string"!==typeof h&&(k.guid=h.guid=h.guid||k.guid||d.guid++);var l=c.match(/^([\w:-]*)\s*(.*)$/),m=l[1]+e.eventNamespace;if(l=l[2])f.on(m,l,k);else b.on(m,k)})},_off:function(a,b){b=(b||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.off(b).off(b);
...
this.focusable.add(a);this._on(a,{focusin:function(a){this._addClass(d(a.currentTarget),null,"ui-state-focus")},focusout:function(a){this._removeClass(d(a.currentTarget),null,"ui-state-focus")}})},_trigger:function(a,b,c){var f,e=this.options[a];c=c||{};b=d.Event(b);b.type=(a===this.widgetEventPrefix?a:this.widgetEventPrefix+a).toLowerCase();b.target=this.element[0];if(a=b.originalEvent)for(f in a)f in b||(b[f]=a[f]);this.element.trigger(b,c);return!(d.isFunction(e)&&!1===e.apply(this.element[0],
[b].concat(c))||b.isDefaultPrevented())}};d.each({show:"fadeIn",hide:"fadeOut"},function(a,b){d.Widget.prototype["_"+a]=function(c,f,e){"string"===typeof f&&(f={effect:f});var g,h=f?!0===f||"number"===typeof f?b:f.effect||b:a;f=f||{};"number"===typeof f&&(f={duration:f});g=!d.isEmptyObject(f);f.complete=e;f.delay&&c.delay(f.delay);if(g&&d.effects&&d.effects.effect[h])c[a](f);else if(h!==a&&c[h])c[h](f.duration,f.easing,e);else c.queue(function(b){d(this)[a]();e&&e.call(c[0]);b()})}});(function(){function a(a,
b,c){return[parseFloat(a[0])*(p.test(a[0])?b/100:1),parseFloat(a[1])*(p.test(a[1])?c/100:1)]}function b(a){var b=a[0];return 9===b.nodeType?{width:a.width(),height:a.height(),offset:{top:0,left:0}}:d.isWindow(b)?{width:a.width(),height:a.height(),offset:{top:a.scrollTop(),left:a.scrollLeft()}}:b.preventDefault?{width:0,height:0,offset:{top:b.pageY,left:b.pageX}}:{width:a.outerWidth(),height:a.outerHeight(),offset:a.offset()}}var c,f,e=Math.max,g=Math.abs,h=Math.round,k=/left|center|right/,l=/top|center|bottom/,
m=/[\+\-]\d+(\.[\d]+)?%?/,n=/^\w+/,p=/%$/,q=d.fn.position;f=function(){var a=d("<div>").css("position","absolute").appendTo("body").offset({top:1.5,left:1.5}),b=1.5===a.offset().top;a.remove();f=function(){return b};return b};d.position={scrollbarWidth:function(){if(void 0!==c)return c;var a,b,f=d("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>");b=f.children()[0];d("body").append(f);a=b.offsetWidth;f.css("overflow",
"scroll");b=b.offsetWidth;a===b&&(b=f[0].clientWidth);f.remove();return c=a-b},getScrollInfo:function(a){var b=a.isWindow||a.isDocument?"":a.element.css("overflow-x"),c=a.isWindow||a.isDocument?"":a.element.css("overflow-y"),b="scroll"===b||"auto"===b&&a.width<a.element[0].scrollWidth;return{width:"scroll"===c||"auto"===c&&a.height<a.element[0].scrollHeight?d.position.scrollbarWidth():0,height:b?d.position.scrollbarWidth():0}},getWithinInfo:function(a){var b=d(a||window),c=d.isWindow(b[0]),f=!!b[0]&&
9===b[0].nodeType;return{element:b,isWindow:c,isDocument:f,offset:c||f?{left:0,top:0}:d(a).offset(),scrollLeft:b.scrollLeft(),scrollTop:b.scrollTop(),width:b.outerWidth(),height:b.outerHeight()}}};d.fn.position=function(c){if(!c||!c.of)return q.apply(this,arguments);c=d.extend({},c);var t,r,w,p,v,H,B=d(c.of),C=d.position.getWithinInfo(c.within),z=d.position.getScrollInfo(C),L=(c.collision||"flip").split(" "),Q={};H=b(B);B[0].preventDefault&&(c.at="left top");r=H.width;w=H.height;p=H.offset;v=d.extend({},
p);d.each(["my","at"],function(){var a=(c[this]||"").split(" "),b,d;1===a.length&&(a=k.test(a[0])?a.concat(["center"]):l.test(a[0])?["center"].concat(a):["center","center"]);a[0]=k.test(a[0])?a[0]:"center";a[1]=l.test(a[1])?a[1]:"center";b=m.exec(a[0]);d=m.exec(a[1]);Q[this]=[b?b[0]:0,d?d[0]:0];c[this]=[n.exec(a[0])[0],n.exec(a[1])[0]]});1===L.length&&(L[1]=L[0]);"right"===c.at[0]?v.left+=r:"center"===c.at[0]&&(v.left+=r/2);"bottom"===c.at[1]?v.top+=w:"center"===c.at[1]&&(v.top+=w/2);t=a(Q.at,r,w);
v.left+=t[0];v.top+=t[1];return this.each(function(){var b,k,l=d(this),m=l.outerWidth(),n=l.outerHeight(),H=parseInt(d.css(this,"marginLeft"),10)||0,q=parseInt(d.css(this,"marginTop"),10)||0,F=m+H+(parseInt(d.css(this,"marginRight"),10)||0)+z.width,E=n+q+(parseInt(d.css(this,"marginBottom"),10)||0)+z.height,x=d.extend({},v),G=a(Q.my,l.outerWidth(),l.outerHeight());"right"===c.my[0]?x.left-=m:"center"===c.my[0]&&(x.left-=m/2);"bottom"===c.my[1]?x.top-=n:"center"===c.my[1]&&(x.top-=n/2);x.left+=G[0];
x.top+=G[1];f()||(x.left=h(x.left),x.top=h(x.top));b={marginLeft:H,marginTop:q};d.each(["left","top"],function(a,f){if(d.ui.position[L[a]])d.ui.position[L[a]][f](x,{targetWidth:r,targetHeight:w,elemWidth:m,elemHeight:n,collisionPosition:b,collisionWidth:F,collisionHeight:E,offset:[t[0]+G[0],t[1]+G[1]],my:c.my,at:c.at,within:C,elem:l})});c.using&&(k=function(a){var b=p.left-x.left,d=b+r-m,f=p.top-x.top,h=f+w-n,k={target:{element:B,left:p.left,top:p.top,width:r,height:w},element:{element:l,left:x.left,
top:x.top,width:m,height:n},horizontal:0>d?"left":0<b?"right":"center",vertical:0>h?"top":0<f?"bottom":"middle"};r<m&&g(b+d)<r&&(k.horizontal="center");w<n&&g(f+h)<w&&(k.vertical="middle");e(g(b),g(d))>e(g(f),g(h))?k.important="horizontal":k.important="vertical";c.using.call(this,a,k)});l.offset(d.extend(x,{using:k}))})};d.ui.position={fit:{left:function(a,b){var c=b.within,d=c.isWindow?c.scrollLeft:c.offset.left,f=c.width,g=a.left-b.collisionPosition.marginLeft,c=d-g,h=g+b.collisionWidth-f-d;b.collisionWidth>
f?0<c&&0>=h?(d=a.left+c+b.collisionWidth-f-d,a.left+=c-d):a.left=0<h&&0>=c?d:c>h?d+f-b.collisionWidth:d:a.left=0<c?a.left+c:0<h?a.left-h:e(a.left-g,a.left)},top:function(a,b){var c=b.within,d=c.isWindow?c.scrollTop:c.offset.top,f=b.within.height,g=a.top-b.collisionPosition.marginTop,c=d-g,h=g+b.collisionHeight-f-d;b.collisionHeight>f?0<c&&0>=h?(d=a.top+c+b.collisionHeight-f-d,a.top+=c-d):a.top=0<h&&0>=c?d:c>h?d+f-b.collisionHeight:d:a.top=0<c?a.top+c:0<h?a.top-h:e(a.top-g,a.top)}},flip:{left:function(a,
b){var c=b.within,d=c.offset.left+c.scrollLeft,f=c.width,e=c.isWindow?c.scrollLeft:c.offset.left,h=a.left-b.collisionPosition.marginLeft,c=h-e,k=h+b.collisionWidth-f-e,h="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0,l="left"===b.at[0]?b.targetWidth:"right"===b.at[0]?-b.targetWidth:0,m=-2*b.offset[0];if(0>c){if(d=a.left+h+l+m+b.collisionWidth-f-d,0>d||d<g(c))a.left+=h+l+m}else 0<k&&(d=a.left-b.collisionPosition.marginLeft+h+l+m-e,0<d||g(d)<k)&&(a.left+=h+l+m)},top:function(a,b){var c=
b.within,d=c.offset.top+c.scrollTop,f=c.height,e=c.isWindow?c.scrollTop:c.offset.top,h=a.top-b.collisionPosition.marginTop,c=h-e,k=h+b.collisionHeight-f-e,h="top"===b.my[1]?-b.elemHeight:"bottom"===b.my[1]?b.elemHeight:0,l="top"===b.at[1]?b.targetHeight:"bottom"===b.at[1]?-b.targetHeight:0,m=-2*b.offset[1];if(0>c){if(d=a.top+h+l+m+b.collisionHeight-f-d,0>d||d<g(c))a.top+=h+l+m}else 0<k&&(d=a.top-b.collisionPosition.marginTop+h+l+m-e,0<d||g(d)<k)&&(a.top+=h+l+m)}},flipfit:{left:function(){d.ui.position.flip.left.apply(this,
arguments);d.ui.position.fit.left.apply(this,arguments)},top:function(){d.ui.position.flip.top.apply(this,arguments);d.ui.position.fit.top.apply(this,arguments)}}}})();d.extend(d.expr[":"],{data:d.expr.createPseudo?d.expr.createPseudo(function(a){return function(b){return!!d.data(b,a)}}):function(a,b,c){return!!d.data(a,c[3])}});d.fn.extend({disableSelection:function(){var a="onselectstart"in document.createElement("div")?"selectstart":"mousedown";return function(){return this.on(a+".ui-disableSelection",
function(a){a.preventDefault()})}}(),enableSelection:function(){return this.off(".ui-disableSelection")}});d.effects={effect:{}};(function(a,b){function c(a,b,c){var d=m[b.type]||{};if(null==a)return c||!b.def?null:b.def;a=d.floor?~~a:parseFloat(a);return isNaN(a)?b.def:d.mod?(a+d.mod)%d.mod:0>a?0:d.max<a?d.max:a}function d(b){var c=k(),f=c._rgba=[];b=b.toLowerCase();u(h,function(a,d){var e,g=d.re.exec(b);e=g&&d.parse(g);g=d.space||"rgba";if(e)return e=c[g](e),c[l[g].cache]=e[l[g].cache],f=c._rgba=
...
c,d,f)},l={rgba:{props:{red:{idx:0,type:"byte"},green:{idx:1,type:"byte"},blue:{idx:2,type:"byte"}}},hsla:{props:{hue:{idx:0,type:"degrees"},saturation:{idx:1,type:"percent"},lightness:{idx:2,type:"percent"}}}},m={"byte":{floor:!0,max:255},percent:{max:1},degrees:{mod:360,floor:!0}},n=k.support={},p=a("<p>")[0],q,u=a.each;p.style.cssText="background-color:rgba(1,1,1,.5)";n.rgba=-1<p.style.backgroundColor.indexOf("rgba");u(l,function(a,b){b.cache="_"+a;b.props.alpha={idx:3,type:"percent",def:1}});
k.fn=a.extend(k.prototype,{parse:function(e,g,h,m){if(e===b)return this._rgba=[null,null,null,null],this;if(e.jquery||e.nodeType)e=a(e).css(g),g=b;var n=this,p=a.type(e),B=this._rgba=[];g!==b&&(e=[e,g,h,m],p="array");if("string"===p)return this.parse(d(e)||q._default);if("array"===p)return u(l.rgba.props,function(a,b){B[b.idx]=c(e[b.idx],b)}),this;if("object"===p)return e instanceof k?u(l,function(a,b){e[b.cache]&&(n[b.cache]=e[b.cache].slice())}):u(l,function(b,d){var f=d.cache;u(d.props,function(a,
b){if(!n[f]&&d.to){if("alpha"===a||null==e[a])return;n[f]=d.to(n._rgba)}n[f][b.idx]=c(e[a],b,!0)});n[f]&&0>a.inArray(null,n[f].slice(0,3))&&(n[f][3]=1,d.from&&(n._rgba=d.from(n[f])))}),this},is:function(a){var b=k(a),c=!0,d=this;u(l,function(a,f){var e,g=b[f.cache];g&&(e=d[f.cache]||f.to&&f.to(d._rgba)||[],u(f.props,function(a,b){if(null!=g[b.idx])return c=g[b.idx]===e[b.idx]}));return c});return c},_space:function(){var a=[],b=this;u(l,function(c,d){b[d.cache]&&a.push(c)});return a.pop()},transition:function(a,
b){var d=k(a),f=d._space(),e=l[f],g=0===this.alpha()?k("transparent"):this,h=g[e.cache]||e.to(g._rgba),n=h.slice(),d=d[e.cache];u(e.props,function(a,f){var e=f.idx,g=h[e],k=d[e],l=m[f.type]||{};null!==k&&(null===g?n[e]=k:(l.mod&&(k-g>l.mod/2?g+=l.mod:g-k>l.mod/2&&(g-=l.mod)),n[e]=c((k-g)*b+g,f)))});return this[f](n)},blend:function(b){if(1===this._rgba[3])return this;var c=this._rgba.slice(),d=c.pop(),f=k(b)._rgba;return k(a.map(c,function(a,b){return(1-d)*f[b]+d*a}))},toRgbaString:function(){var b=
"rgba(",c=a.map(this._rgba,function(a,b){return null==a?2<b?1:0:a});1===c[3]&&(c.pop(),b="rgb(");return b+c.join()+")"},toHslaString:function(){var b="hsla(",c=a.map(this.hsla(),function(a,b){null==a&&(a=2<b?1:0);b&&3>b&&(a=Math.round(100*a)+"%");return a});1===c[3]&&(c.pop(),b="hsl(");return b+c.join()+")"},toHexString:function(b){var c=this._rgba.slice(),d=c.pop();b&&c.push(~~(255*d));return"#"+a.map(c,function(a){a=(a||0).toString(16);return 1===a.length?"0"+a:a}).join("")},toString:function(){return 0===
this._rgba[3]?"transparent":this.toRgbaString()}});k.fn.parse.prototype=k.fn;l.hsla.to=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b=a[0]/255,c=a[1]/255,d=a[2]/255;a=a[3];var f=Math.max(b,c,d),e=Math.min(b,c,d),g=f-e,h=f+e,k=.5*h;return[Math.round(e===f?0:b===f?60*(c-d)/g+360:c===f?60*(d-b)/g+120:60*(b-c)/g+240)%360,0===g?0:.5>=k?g/h:g/(2-h),k,null==a?1:a]};l.hsla.from=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b=a[0]/360,
c=a[1],d=a[2];a=a[3];c=.5>=d?d*(1+c):d+c-d*c;d=2*d-c;return[Math.round(255*e(d,c,b+1/3)),Math.round(255*e(d,c,b)),Math.round(255*e(d,c,b-1/3)),a]};u(l,function(d,f){var e=f.props,h=f.cache,l=f.to,m=f.from;k.fn[d]=function(d){l&&!this[h]&&(this[h]=l(this._rgba));if(d===b)return this[h].slice();var f,g=a.type(d),n="array"===g||"object"===g?d:arguments,p=this[h].slice();u(e,function(a,b){var d=n["object"===g?a:b.idx];null==d&&(d=p[b.idx]);p[b.idx]=c(d,b)});return m?(f=k(m(p)),f[h]=p,f):k(p)};u(e,function(b,
c){k.fn[b]||(k.fn[b]=function(f){var e=a.type(f),h="alpha"===b?this._hsla?"hsla":"rgba":d,k=this[h](),l=k[c.idx];if("undefined"===e)return l;"function"===e&&(f=f.call(this,l),e=a.type(f));if(null==f&&c.empty)return this;"string"===e&&(e=g.exec(f))&&(f=l+parseFloat(e[2])*("+"===e[1]?1:-1));k[c.idx]=f;return this[h](k)})})});k.hook=function(b){b=b.split(" ");u(b,function(b,c){a.cssHooks[c]={set:function(b,e){var g,h="";if("transparent"!==e&&("string"!==a.type(e)||(g=d(e)))){e=k(g||e);if(!n.rgba&&1!==
e._rgba[3]){for(g="backgroundColor"===c?b.parentNode:b;(""===h||"transparent"===h)&&g&&g.style;)try{h=a.css(g,"backgroundColor"),g=g.parentNode}catch(l){}e=e.blend(h&&"transparent"!==h?h:"_default")}e=e.toRgbaString()}try{b.style[c]=e}catch(l){}}};a.fx.step[c]=function(b){b.colorInit||(b.start=k(b.elem,c),b.end=k(b.end),b.colorInit=!0);a.cssHooks[c].set(b.elem,b.start.transition(b.end,b.pos))}})};k.hook("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor");
...
"+=",l={opacity:0};d.effects.createPlaceholder(f);c=a.distance||f["top"===g?"outerHeight":"outerWidth"](!0)/2;l[g]=h+c;e&&(f.css(l),l[g]=k+c,l.opacity=1);f.animate(l,{queue:!1,duration:a.duration,easing:a.easing,complete:b})});d.effects.define("explode","hide",function(a,b){function c(){w.push(this);w.length===m*n&&(p.css({visibility:"visible"}),d(w).remove(),b())}var f,e,g,h,k,l,m=a.pieces?Math.round(Math.sqrt(a.pieces)):3,n=m,p=d(this),q="show"===a.mode,u=p.show().css("visibility","hidden").offset(),
t=Math.ceil(p.outerWidth()/n),r=Math.ceil(p.outerHeight()/m),w=[];for(f=0;f<m;f++)for(h=u.top+f*r,l=f-(m-1)/2,e=0;e<n;e++)g=u.left+e*t,k=e-(n-1)/2,p.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-e*t,top:-f*r}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:t,height:r,left:g+(q?k*t:0),top:h+(q?l*r:0),opacity:q?0:1}).animate({left:g+(q?0:k*t),top:h+(q?0:l*r),opacity:q?1:0},a.duration||500,a.easing,c)});d.effects.define("fade",
"toggle",function(a,b){var c="show"===a.mode;d(this).css("opacity",c?0:1).animate({opacity:c?1:0},{queue:!1,duration:a.duration,easing:a.easing,complete:b})});d.effects.define("fold","hide",function(a,b){var c=d(this),f=a.mode,e="show"===f,f="hide"===f,g=a.size||15,h=/([0-9]+)%/.exec(g),k=a.horizFirst?["right","bottom"]:["bottom","right"],l=a.duration/2,m=d.effects.createPlaceholder(c),n=c.cssClip(),p={clip:d.extend({},n)},q={clip:d.extend({},n)},u=[n[k[0]],n[k[1]]],t=c.queue().length;h&&(g=parseInt(h[1],
10)/100*u[f?0:1]);p.clip[k[0]]=g;q.clip[k[0]]=g;q.clip[k[1]]=0;e&&(c.cssClip(q.clip),m&&m.css(d.effects.clipToBox(q)),q.clip=n);c.queue(function(b){m&&m.animate(d.effects.clipToBox(p),l,a.easing).animate(d.effects.clipToBox(q),l,a.easing);b()}).animate(p,l,a.easing).animate(q,l,a.easing).queue(b);d.effects.unshift(c,t,4)});d.effects.define("highlight","show",function(a,b){var c=d(this),f={backgroundColor:c.css("backgroundColor")};"hide"===a.mode&&(f.opacity=0);d.effects.saveStyle(c);c.css({backgroundImage:"none",
backgroundColor:a.color||"#ffff99"}).animate(f,{queue:!1,duration:a.duration,easing:a.easing,complete:b})});d.effects.define("size",function(a,b){var c,f,e,g,h,k,l=d(this),m=["fontSize"],n=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],p=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"];k=a.mode;var q="effect"!==k,u=a.scale||"both";h=a.origin||["middle","center"];var t=l.css("position"),r=l.position(),w=d.effects.scaledDimensions(l),y=a.from||w,v=a.to||d.effects.scaledDimensions(l,
0);d.effects.createPlaceholder(l);"show"===k&&(k=y,y=v,v=k);e=y.height/w.height;g=y.width/w.width;c=v.height/w.height;f=v.width/w.width;if("box"===u||"both"===u)e!==c&&(y=d.effects.setTransition(l,n,e,y),v=d.effects.setTransition(l,n,c,v)),g!==f&&(y=d.effects.setTransition(l,p,g,y),v=d.effects.setTransition(l,p,f,v));"content"!==u&&"both"!==u||e===c||(y=d.effects.setTransition(l,m,e,y),v=d.effects.setTransition(l,m,c,v));h&&(h=d.effects.getBaseline(h,w),y.top=(w.outerHeight-y.outerHeight)*h.y+r.top,
y.left=(w.outerWidth-y.outerWidth)*h.x+r.left,v.top=(w.outerHeight-v.outerHeight)*h.y+r.top,v.left=(w.outerWidth-v.outerWidth)*h.x+r.left);l.css(y);if("content"===u||"both"===u)n=n.concat(["marginTop","marginBottom"]).concat(m),p=p.concat(["marginLeft","marginRight"]),l.find("*[width]").each(function(){var b=d(this),h=d.effects.scaledDimensions(b),k={height:h.height*e,width:h.width*g,outerHeight:h.outerHeight*e,outerWidth:h.outerWidth*g},h={height:h.height*c,width:h.width*f,outerHeight:h.height*c,
outerWidth:h.width*f};e!==c&&(k=d.effects.setTransition(b,n,e,k),h=d.effects.setTransition(b,n,c,h));g!==f&&(k=d.effects.setTransition(b,p,g,k),h=d.effects.setTransition(b,p,f,h));q&&d.effects.saveStyle(b);b.css(k);b.animate(h,a.duration,a.easing,function(){q&&d.effects.restoreStyle(b)})});l.animate(v,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){var a=l.offset();0===v.opacity&&l.css("opacity",y.opacity);q||(l.css("position","static"===t?"relative":t).offset(a),d.effects.saveStyle(l));
...
e||"down"===e?"top":"left",e="up"===e||"left"===e,n={},p={},q={},u=f.queue().length;d.effects.createPlaceholder(f);n[m]=(e?"-=":"+=")+g;p[m]=(e?"+=":"-=")+2*g;q[m]=(e?"-=":"+=")+2*g;for(f.animate(n,l,a.easing);c<h;c++)f.animate(p,l,a.easing).animate(q,l,a.easing);f.animate(p,l,a.easing).animate(n,l/2,a.easing).queue(b);d.effects.unshift(f,u,k+1)});d.effects.define("slide","show",function(a,b){var c,f,e=d(this),g={up:["bottom","top"],down:["top","bottom"],left:["right","left"],right:["left","right"]},
...
this._formResetHandler);a.push(this);this.form.data("ui-form-reset-instances",a)}},_unbindFormResetHandler:function(){if(this.form.length){var a=this.form.data("ui-form-reset-instances");a.splice(d.inArray(this,a),1);a.length?this.form.data("ui-form-reset-instances",a):this.form.removeData("ui-form-reset-instances").off("reset.ui-form-reset")}}};"1.7"===d.fn.jquery.substring(0,3)&&(d.each(["Width","Height"],function(a,b){function c(a,b,c,e){d.each(f,function(){b-=parseFloat(d.css(a,"padding"+this))||
0;c&&(b-=parseFloat(d.css(a,"border"+this+"Width"))||0);e&&(b-=parseFloat(d.css(a,"margin"+this))||0)});return b}var f="Width"===b?["Left","Right"]:["Top","Bottom"],e=b.toLowerCase(),g={innerWidth:d.fn.innerWidth,innerHeight:d.fn.innerHeight,outerWidth:d.fn.outerWidth,outerHeight:d.fn.outerHeight};d.fn["inner"+b]=function(a){return void 0===a?g["inner"+b].call(this):this.each(function(){d(this).css(e,c(this,a)+"px")})};d.fn["outer"+b]=function(a,f){return"number"!==typeof a?g["outer"+b].call(this,
a):this.each(function(){d(this).css(e,c(this,a,!0,f)+"px")})}}),d.fn.addBack=function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))});d.ui.keyCode={BACKSPACE:8,COMMA:188,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,LEFT:37,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SPACE:32,TAB:9,UP:38};d.ui.escapeSelector=function(){var a=/([!"#$%&'()*+,./:;<=>?@[\]^`{|}~])/g;return function(b){return b.replace(a,"\\$1")}}();d.fn.labels=function(){var a,b,c;if(this[0].labels&&this[0].labels.length)return this.pushStack(this[0].labels);
...
d(this),b=a.uniqueId().attr("id"),c=a.next(),f=c.uniqueId().attr("id");a.attr("aria-controls",f);c.attr("aria-labelledby",b)}).next().attr("role","tabpanel");this.headers.not(this.active).attr({"aria-selected":"false","aria-expanded":"false",tabIndex:-1}).next().attr({"aria-hidden":"true"}).hide();this.active.length?this.active.attr({"aria-selected":"true","aria-expanded":"true",tabIndex:0}).next().attr({"aria-hidden":"false"}):this.headers.eq(0).attr("tabIndex",0);this._createIcons();this._setupEvents(b.event);
"fill"===c?(a=f.height(),this.element.siblings(":visible").each(function(){var b=d(this),c=b.css("position");"absolute"!==c&&"fixed"!==c&&(a-=b.outerHeight(!0))}),this.headers.each(function(){a-=d(this).outerHeight(!0)}),this.headers.next().each(function(){d(this).height(Math.max(0,a-d(this).innerHeight()+d(this).height()))}).css("overflow","auto")):"auto"===c&&(a=0,this.headers.next().each(function(){var b=d(this).is(":visible");b||d(this).show();a=Math.max(a,d(this).css("height","").height());b||
...
_animate:function(a,b,c){var d,e,g,h=this,k=0,l=a.css("box-sizing"),m=a.length&&(!b.length||a.index()<b.index()),n=this.options.animate||{},m=m&&n.down||n,p=function(){h._toggleComplete(c)};"number"===typeof m&&(g=m);"string"===typeof m&&(e=m);e=e||m.easing||n.easing;g=g||m.duration||n.duration;if(!b.length)return a.animate(this.showProps,g,e,p);if(!a.length)return b.animate(this.hideProps,g,e,p);d=a.show().outerHeight();b.animate(this.hideProps,{duration:g,easing:e,step:function(a,b){b.now=Math.round(a)}});
...
null,a)}});d.ui.safeActiveElement=function(a){var b;try{b=a.activeElement}catch(c){b=a.body}b||(b=a.body);b.nodeName||(b=a.body);return b};d.widget("ui.menu",{version:"1.12.0",defaultElement:"<ul>",delay:300,options:{icons:{submenu:"ui-icon-caret-1-e"},items:"> *",menus:"ul",position:{my:"left top",at:"right top"},role:"menu",blur:null,focus:null,select:null},_create:function(){this.activeMenu=this.element;this.mouseHandled=!1;this.element.uniqueId().attr({role:this.options.role,tabIndex:0});this._addClass("ui-menu",
...
clearTimeout(this.timer)))},"mouseenter .ui-menu-item":function(a){if(!this.previousFilter){var b=d(a.target).closest(".ui-menu-item"),c=d(a.currentTarget);b[0]===c[0]&&(this._removeClass(c.siblings().children(".ui-state-active"),null,"ui-state-active"),this.focus(a,c))}},mouseleave:"collapseAll","mouseleave .ui-menu":"collapseAll",focus:function(a,b){var c=this.active||this.element.find(this.options.items).eq(0);b||this.focus(a,c)},blur:function(a){this._delay(function(){d.contains(this.element[0],
...
"aria-hidden":"true","aria-expanded":"false"}).each(function(){var a=d(this),b=a.prev(),c=d("<span>").data("ui-menu-submenu-caret",!0);f._addClass(c,"ui-menu-icon","ui-icon "+e);b.attr("aria-haspopup","true").prepend(c);a.attr("aria-labelledby",b.attr("id"))});this._addClass(a,"ui-menu","ui-widget ui-widget-content ui-front");a=b.add(this.element).find(this.options.items);a.not(".ui-menu-item").each(function(){var a=d(this);f._isDivider(a)&&f._addClass(a,"ui-menu-divider","ui-widget-content")});b=
a.not(".ui-menu-item, .ui-menu-divider");c=b.children().not(".ui-menu").uniqueId().attr({tabIndex:-1,role:this._itemRole()});this._addClass(b,"ui-menu-item")._addClass(c,"ui-menu-item-wrapper");a.filter(".ui-state-disabled").attr("aria-disabled","true");this.active&&!d.contains(this.element[0],this.active[0])&&this.blur()},_itemRole:function(){return{menu:"menuitem",listbox:"option"}[this.options.role]},_setOption:function(a,b){if("icons"===a){var c=this.element.find(".ui-menu-icon");this._removeClass(c,
...
this._addClass(c,null,"ui-state-active");a&&"keydown"===a.type?this._close():this.timer=this._delay(function(){this._close()},this.delay);c=b.children(".ui-menu");c.length&&a&&/^mouse/.test(a.type)&&this._startOpening(c);this.activeMenu=b.parent();this._trigger("focus",a,{item:b})},_scrollIntoView:function(a){var b,c,f;this._hasScroll()&&(b=parseFloat(d.css(this.activeMenu[0],"borderTopWidth"))||0,c=parseFloat(d.css(this.activeMenu[0],"paddingTop"))||0,b=a.offset().top-this.activeMenu.offset().top-
b-c,c=this.activeMenu.scrollTop(),f=this.activeMenu.height(),a=a.outerHeight(),0>b?this.activeMenu.scrollTop(c+b):b+a>f&&this.activeMenu.scrollTop(c+b-f+a))},blur:function(a,b){b||clearTimeout(this.timer);this.active&&(this._removeClass(this.active.children(".ui-menu-item-wrapper"),null,"ui-state-active"),this._trigger("blur",a,{item:this.active}),this.active=null)},_startOpening:function(a){clearTimeout(this.timer);"true"===a.attr("aria-hidden")&&(this.timer=this._delay(function(){this._close();
this._open(a)},this.delay))},_open:function(a){var b=d.extend({of:this.active},this.options.position);clearTimeout(this.timer);this.element.find(".ui-menu").not(a.parents(".ui-menu")).hide().attr("aria-hidden","true");a.show().removeAttr("aria-hidden").attr("aria-expanded","true").position(b)},collapseAll:function(a,b){clearTimeout(this.timer);this.timer=this._delay(function(){var c=b?this.element:d(a&&a.target).closest(this.element.find(".ui-menu"));c.length||(c=this.element);this._close(c);this.blur(a);
...
select:function(a){this.active=this.active||d(a.target).closest(".ui-menu-item");var b={item:this.active};this.active.has(".ui-menu").length||this.collapseAll(a,!0);this._trigger("select",a,b)},_filterMenuItems:function(a){a=a.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&");var b=new RegExp("^"+a,"i");return this.activeMenu.find(this.options.items).filter(".ui-menu-item").filter(function(){return b.test(d.trim(d(this).children(".ui-menu-item-wrapper").text()))})}});d.widget("ui.autocomplete",{version:"1.12.0",
...
this.element.attr("autocomplete","off");this._on(this.element,{keydown:function(f){if(this.element.prop("readOnly"))b=c=a=!0;else{b=c=a=!1;var e=d.ui.keyCode;switch(f.keyCode){case e.PAGE_UP:a=!0;this._move("previousPage",f);break;case e.PAGE_DOWN:a=!0;this._move("nextPage",f);break;case e.UP:a=!0;this._keyEvent("previous",f);break;case e.DOWN:a=!0;this._keyEvent("next",f);break;case e.ENTER:this.menu.active&&(a=!0,f.preventDefault(),this.menu.select(f));break;case e.TAB:this.menu.active&&this.menu.select(f);
break;case e.ESCAPE:this.menu.element.is(":visible")&&(this.isMultiLine||this._value(this.term),this.close(f),f.preventDefault());break;default:b=!0,this._searchTimeout(f)}}},keypress:function(c){if(a)a=!1,this.isMultiLine&&!this.menu.element.is(":visible")||c.preventDefault();else if(!b){var f=d.ui.keyCode;switch(c.keyCode){case f.PAGE_UP:this._move("previousPage",c);break;case f.PAGE_DOWN:this._move("nextPage",c);break;case f.UP:this._keyEvent("previous",c);break;case f.DOWN:this._keyEvent("next",
...
a.length||(a=this.document[0].body);return a},_initSource:function(){var a,b,c=this;d.isArray(this.options.source)?(a=this.options.source,this.source=function(b,c){c(d.ui.autocomplete.filter(a,b.term))}):"string"===typeof this.options.source?(b=this.options.source,this.source=function(a,e){c.xhr&&c.xhr.abort();c.xhr=d.ajax({url:b,data:a,dataType:"json",success:function(a){e(a)},error:function(){e([])}})}):this.source=this.options.source},_searchTimeout:function(a){clearTimeout(this.searching);this.searching=
...
d.ui.autocomplete,{options:{messages:{noResults:"No search results.",results:function(a){return a+(1<a?" results are":" result is")+" available, use up and down arrow keys to navigate."}}},__response:function(a){var b;this._superApply(arguments);this.options.disabled||this.cancelSearch||(b=a&&a.length?this.options.messages.results(a.length):this.options.messages.noResults,this.liveRegion.children().hide(),d("<div>").text(b).appendTo(this.liveRegion))}});var X=/ui-corner-([a-z]){2,6}/g;d.widget("ui.controlgroup",
...
a._addClass(e,null,"ui-widget ui-widget-content ui-state-default"),b=b.concat(e.get())):d.fn[c]&&(a["_"+c+"Options"]&&(g=a["_"+c+"Options"]("middle")),a.element.find(f).each(function(){var f=d(this),e=f[c]("instance"),l=d.widget.extend({},g);"button"===c&&f.parent(".ui-spinner").length||(e||(e=f[c]()[c]("instance")),e&&(l.classes=a._resolveClassesValues(l.classes,e)),f[c](l),l=f[c]("widget"),d.data(l[0],"ui-controlgroup-data",e?e:f[c]("instance")),b.push(l[0]))})))});this.childWidgets=d(d.unique(b));
this._addClass(this.childWidgets,"ui-controlgroup-item")},_callChildMethod:function(a){this.childWidgets.each(function(){var b=d(this).data("ui-controlgroup-data");if(b&&b[a])b[a]()})},_updateCornerClass:function(a,b){var c=this._buildSimpleOptions(b,"label").classes.label;this._removeClass(a,null,"ui-corner-top ui-corner-bottom ui-corner-left ui-corner-right ui-corner-all");this._addClass(a,null,c)},_buildSimpleOptions:function(a,b){var c="vertical"===this.options.direction,d={classes:{}};d.classes[b]=
...
this._updateTooltip())},_updateTooltip:function(){this.title=this.element.attr("title");this.options.showLabel||this.title||this.element.attr("title",this.options.label)},_updateIcon:function(a,b){var c="iconPosition"!==a,f=c?this.options.iconPosition:b,e="top"===f||"bottom"===f;this.icon?c&&this._removeClass(this.icon,null,this.options.icon):(this.icon=d("<span>"),this._addClass(this.icon,"ui-button-icon","ui-icon"),this.options.showLabel||this._addClass("ui-button-icon-only"));c&&this._addClass(this.icon,
...
this._disableDatepicker(a),b.dpDiv.css("display","block"))},_dialogDatepicker:function(a,b,c,f,e){var g;a=this._dialogInst;a||(this.uuid+=1,a="dp"+this.uuid,this._dialogInput=d("<input type='text' id='"+a+"' style='position: absolute; top: -100px; width: 0px;'/>"),this._dialogInput.on("keydown",this._doKeyDown),d("body").append(this._dialogInput),a=this._dialogInst=this._newInst(this._dialogInput,!1),a.settings={},d.data(this._dialogInput[0],"datepicker",a));K(a.settings,f||{});b=b&&b.constructor===
...
typeof b)return"defaults"===b?d.extend({},d.datepicker._defaults):k?"all"===b?d.extend({},k.settings):this._get(k,b):null;f=b||{};"string"===typeof b&&(f={},f[b]=c);k&&(this._curInst===k&&this._hideDatepicker(),e=this._getDateDatepicker(a,!0),g=this._getMinMaxDate(k,"min"),h=this._getMinMaxDate(k,"max"),K(k.settings,f),null!==g&&void 0!==f.dateFormat&&void 0===f.minDate&&(k.settings.minDate=this._formatDate(k,g)),null!==h&&void 0!==f.dateFormat&&void 0===f.maxDate&&(k.settings.maxDate=this._formatDate(k,
...
c.apply(a,[a,b]):{};if(!1!==c&&(K(b.settings,c),b.lastVal=null,d.datepicker._lastInput=a,d.datepicker._setDateFromField(b),d.datepicker._inDialog&&(a.value=""),d.datepicker._pos||(d.datepicker._pos=d.datepicker._findPos(a),d.datepicker._pos[1]+=a.offsetHeight),f=!1,d(a).parents().each(function(){f|="fixed"===d(this).css("position");return!f}),c={left:d.datepicker._pos[0],top:d.datepicker._pos[1]},d.datepicker._pos=null,b.dpDiv.empty(),b.dpDiv.css({position:"absolute",display:"block",top:"-1000px"}),
...
b.input.trigger("focus");d.datepicker._curInst=b}}},_updateDatepicker:function(a){this.maxRows=4;F=a;a.dpDiv.empty().append(this._generateHTML(a));this._attachHandlers(a);var b,c=this._getNumberOfMonths(a),f=c[1],e=a.dpDiv.find("."+this._dayOverClass+" a");0<e.length&&T.apply(e.get(0));a.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width("");1<f&&a.dpDiv.addClass("ui-datepicker-multi-"+f).css("width",17*f+"em");a.dpDiv[(1!==c[0]||1!==c[1]?"add":"remove")+
...
null==b)throw"Invalid arguments";b="object"===typeof b?b.toString():b+"";if(""===b)return null;var f,e,g,h=0;e=(c?c.shortYearCutoff:null)||this._defaults.shortYearCutoff;e="string"!==typeof e?e:(new Date).getFullYear()%100+parseInt(e,10);g=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort;var k=(c?c.dayNames:null)||this._defaults.dayNames,l=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort,m=(c?c.monthNames:null)||this._defaults.monthNames,n=c=-1,p=-1,q=-1,u=!1,t,r=function(b){(b=f+
1<a.length&&a.charAt(f+1)===b)&&f++;return b},w=function(a){var c=r(a),c="@"===a?14:"!"===a?20:"y"===a&&c?4:"o"===a?3:2;a=new RegExp("^\\d{"+("y"===a?c:1)+","+c+"}");a=b.substring(h).match(a);if(!a)throw"Missing number at position "+h;h+=a[0].length;return parseInt(a[0],10)},y=function(a,c,f){var e=-1;a=d.map(r(a)?f:c,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)});d.each(a,function(a,c){var d=c[1];if(b.substr(h,d.length).toLowerCase()===d.toLowerCase())return e=
c[0],h+=d.length,!1});if(-1!==e)return e+1;throw"Unknown name at position "+h;},v=function(){if(b.charAt(h)!==a.charAt(f))throw"Unexpected literal at position "+h;h++};for(f=0;f<a.length;f++)if(u)"'"!==a.charAt(f)||r("'")?v():u=!1;else switch(a.charAt(f)){case "d":p=w("d");break;case "D":y("D",g,k);break;case "o":q=w("o");break;case "m":n=w("m");break;case "M":n=y("M",l,m);break;case "y":c=w("y");break;case "@":t=new Date(w("@"));c=t.getFullYear();n=t.getMonth()+1;p=t.getDate();break;case "!":t=new Date((w("!")-
this._ticksTo1970)/1E4);c=t.getFullYear();n=t.getMonth()+1;p=t.getDate();break;case "'":r("'")?v():u=!0;break;default:v()}if(h<b.length&&(g=b.substr(h),!/^\s+/.test(g)))throw"Extra/unparsed characters found in date: "+g;-1===c?c=(new Date).getFullYear():100>c&&(c+=(new Date).getFullYear()-(new Date).getFullYear()%100+(c<=e?0:-100));if(-1<q){n=1;p=q;do{e=this._getDaysInMonth(c,n-1);if(p<=e)break;n++;p-=e}while(1)}t=this._daylightSavingAdjust(new Date(c,n-1,p));if(t.getFullYear()!==c||t.getMonth()+
...
this);return!1},selectMonth:function(){d.datepicker._selectMonthYear(c,this,"M");return!1},selectYear:function(){d.datepicker._selectMonthYear(c,this,"Y");return!1}}[this.getAttribute("data-handler")])})},_generateHTML:function(a){var b,c,d,e,g,h,k,l,m,n,p,q,u,t,r,w,y,v,H,B,C,z,L,F,E,P,K,N=new Date,N=this._daylightSavingAdjust(new Date(N.getFullYear(),N.getMonth(),N.getDate())),I=this._get(a,"isRTL");h=this._get(a,"showButtonPanel");d=this._get(a,"hideIfNoPrevNext");g=this._get(a,"navigationAsDateFormat");
var J=this._getNumberOfMonths(a),A=this._get(a,"showCurrentAtPos");e=this._get(a,"stepMonths");var M=1!==J[0]||1!==J[1],O=this._daylightSavingAdjust(a.currentDay?new Date(a.currentYear,a.currentMonth,a.currentDay):new Date(9999,9,9)),x=this._getMinMaxDate(a,"min"),G=this._getMinMaxDate(a,"max"),A=a.drawMonth-A,D=a.drawYear;0>A&&(A+=12,D--);if(G)for(b=this._daylightSavingAdjust(new Date(G.getFullYear(),G.getMonth()-J[0]*J[1]+1,G.getDate())),b=x&&b<x?x:b;this._daylightSavingAdjust(new Date(D,A,1))>
b;)A--,0>A&&(A=11,D--);a.drawMonth=A;a.drawYear=D;b=this._get(a,"prevText");b=g?this.formatDate(b,this._daylightSavingAdjust(new Date(D,A-e,1)),this._getFormatConfig(a)):b;b=this._canAdjustMonth(a,-1,D,A)?"<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='"+b+"'><span class='ui-icon ui-icon-circle-triangle-"+(I?"e":"w")+"'>"+b+"</span></a>":d?"":"<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='"+b+"'><span class='ui-icon ui-icon-circle-triangle-"+
(I?"e":"w")+"'>"+b+"</span></a>";c=this._get(a,"nextText");c=g?this.formatDate(c,this._daylightSavingAdjust(new Date(D,A+e,1)),this._getFormatConfig(a)):c;d=this._canAdjustMonth(a,1,D,A)?"<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='"+c+"'><span class='ui-icon ui-icon-circle-triangle-"+(I?"w":"e")+"'>"+c+"</span></a>":d?"":"<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='"+c+"'><span class='ui-icon ui-icon-circle-triangle-"+(I?"w":
"e")+"'>"+c+"</span></a>";e=this._get(a,"currentText");c=this._get(a,"gotoCurrent")&&a.currentDay?O:N;e=g?this.formatDate(e,c,this._getFormatConfig(a)):e;g=a.inline?"":"<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>"+this._get(a,"closeText")+"</button>";h=h?"<div class='ui-datepicker-buttonpane ui-widget-content'>"+(I?g:"")+(this._isInRange(a,c)?"<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>"+
e+"</button>":"")+(I?"":g)+"</div>":"";g=parseInt(this._get(a,"firstDay"),10);g=isNaN(g)?0:g;e=this._get(a,"showWeek");c=this._get(a,"dayNames");k=this._get(a,"dayNamesMin");l=this._get(a,"monthNames");m=this._get(a,"monthNamesShort");n=this._get(a,"beforeShowDay");p=this._get(a,"showOtherMonths");q=this._get(a,"selectOtherMonths");u=this._getDefaultDate(a);t="";for(w=0;w<J[0];w++){y="";this.maxRows=4;for(v=0;v<J[1];v++){H=this._daylightSavingAdjust(new Date(D,A,a.selectedDay));r=" ui-corner-all";
B="";if(M){B+="<div class='ui-datepicker-group";if(1<J[1])switch(v){case 0:B+=" ui-datepicker-group-first";r=" ui-corner-"+(I?"right":"left");break;case J[1]-1:B+=" ui-datepicker-group-last";r=" ui-corner-"+(I?"left":"right");break;default:B+=" ui-datepicker-group-middle",r=""}B+="'>"}B+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+r+"'>"+(/all|left/.test(r)&&0===w?I?d:b:"")+(/all|right/.test(r)&&0===w?I?b:d:"")+this._generateMonthYearHeader(a,A,D,x,G,0<w||0<v,l,m)+"</div><table class='ui-datepicker-calendar'><thead><tr>";
C=e?"<th class='ui-datepicker-week-col'>"+this._get(a,"weekHeader")+"</th>":"";for(r=0;7>r;r++)z=(r+g)%7,C+="<th scope='col'"+(5<=(r+g+6)%7?" class='ui-datepicker-week-end'":"")+"><span title='"+c[z]+"'>"+k[z]+"</span></th>";B+=C+"</tr></thead><tbody>";C=this._getDaysInMonth(D,A);D===a.selectedYear&&A===a.selectedMonth&&(a.selectedDay=Math.min(a.selectedDay,C));r=(this._getFirstDayOfMonth(D,A)-g+7)%7;C=Math.ceil((r+C)/7);this.maxRows=C=M?this.maxRows>C?this.maxRows:C:C;z=this._daylightSavingAdjust(new Date(D,
A,1-r));for(L=0;L<C;L++){B+="<tr>";F=e?"<td class='ui-datepicker-week-col'>"+this._get(a,"calculateWeek")(z)+"</td>":"";for(r=0;7>r;r++)E=n?n.apply(a.input?a.input[0]:null,[z]):[!0,""],K=(P=z.getMonth()!==A)&&!q||!E[0]||x&&z<x||G&&z>G,F+="<td class='"+(5<=(r+g+6)%7?" ui-datepicker-week-end":"")+(P?" ui-datepicker-other-month":"")+(z.getTime()===H.getTime()&&A===a.selectedMonth&&a._keyEvent||u.getTime()===z.getTime()&&u.getTime()===H.getTime()?" "+this._dayOverClass:"")+(K?" "+this._unselectableClass+
" ui-state-disabled":"")+(P&&!p?"":" "+E[1]+(z.getTime()===O.getTime()?" "+this._currentClass:"")+(z.getTime()===N.getTime()?" ui-datepicker-today":""))+"'"+(P&&!p||!E[2]?"":" title='"+E[2].replace(/'/g,"&#39;")+"'")+(K?"":" data-handler='selectDay' data-event='click' data-month='"+z.getMonth()+"' data-year='"+z.getFullYear()+"'")+">"+(P&&!p?"&#xa0;":K?"<span class='ui-state-default'>"+z.getDate()+"</span>":"<a class='ui-state-default"+(z.getTime()===N.getTime()?" ui-state-highlight":"")+(z.getTime()===
O.getTime()?" ui-state-active":"")+(P?" ui-priority-secondary":"")+"' href='#'>"+z.getDate()+"</a>")+"</td>",z.setDate(z.getDate()+1),z=this._daylightSavingAdjust(z);B+=F+"</tr>"}A++;11<A&&(A=0,D++);B+="</tbody></table>"+(M?"</div>"+(0<J[0]&&v===J[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");y+=B}t+=y}a._keyEvent=!1;return t+h},_generateMonthYearHeader:function(a,b,c,d,e,g,h,k){var l,m,n,p=this._get(a,"changeMonth"),q=this._get(a,"changeYear"),u=this._get(a,"showMonthAfterYear"),t="<div class='ui-datepicker-title'>",
r="";if(g||!p)r+="<span class='ui-datepicker-month'>"+h[b]+"</span>";else{h=d&&d.getFullYear()===c;l=e&&e.getFullYear()===c;r+="<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>";for(m=0;12>m;m++)(!h||m>=d.getMonth())&&(!l||m<=e.getMonth())&&(r+="<option value='"+m+"'"+(m===b?" selected='selected'":"")+">"+k[m]+"</option>");r+="</select>"}u||(t+=r+(!g&&p&&q?"":"&#xa0;"));if(!a.yearshtml)if(a.yearshtml="",g||!q)t+="<span class='ui-datepicker-year'>"+c+"</span>";else{k=
...
a.yearshtml+="</select>";t+=a.yearshtml;a.yearshtml=null}t+=this._get(a,"yearSuffix");u&&(t+=(!g&&p&&q?"":"&#xa0;")+r);return t+"</div>"},_adjustInstDate:function(a,b,c){var d=a.selectedYear+("Y"===c?b:0),e=a.selectedMonth+("M"===c?b:0);b=Math.min(a.selectedDay,this._getDaysInMonth(d,e))+("D"===c?b:0);d=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(d,e,b)));a.selectedDay=d.getDate();a.drawMonth=a.selectedMonth=d.getMonth();a.drawYear=a.selectedYear=d.getFullYear();"M"!==c&&"Y"!==c||this._notifyChange(a)},
...
this.widgetName+".preventClickEvent")&&d.removeData(a.target,this.widgetName+".preventClickEvent");this._mouseMoveDelegate=function(a){return b._mouseMove(a)};this._mouseUpDelegate=function(a){return b._mouseUp(a)};this.document.on("mousemove."+this.widgetName,this._mouseMoveDelegate).on("mouseup."+this.widgetName,this._mouseUpDelegate);a.preventDefault();return M=!0}},_mouseMove:function(a){if(this._mouseMoved){if(d.ui.ie&&(!document.documentMode||9>document.documentMode)&&!a.button)return this._mouseUp(a);
if(!a.which)if(a.originalEvent.altKey||a.originalEvent.ctrlKey||a.originalEvent.metaKey||a.originalEvent.shiftKey)this.ignoreMissingWhich=!0;else if(!this.ignoreMissingWhich)return this._mouseUp(a)}if(a.which||a.button)this._mouseMoved=!0;if(this._mouseStarted)return this._mouseDrag(a),a.preventDefault();this._mouseDistanceMet(a)&&this._mouseDelayMet(a)&&((this._mouseStarted=!1!==this._mouseStart(this._mouseDownEvent,a))?this._mouseDrag(a):this._mouseUp(a));return!this._mouseStarted},_mouseUp:function(a){this.document.off("mousemove."+
this.widgetName,this._mouseMoveDelegate).off("mouseup."+this.widgetName,this._mouseUpDelegate);this._mouseStarted&&(this._mouseStarted=!1,a.target===this._mouseDownEvent.target&&d.data(a.target,this.widgetName+".preventClickEvent",!0),this._mouseStop(a));this._mouseDelayTimer&&(clearTimeout(this._mouseDelayTimer),delete this._mouseDelayTimer);M=this.ignoreMissingWhich=!1;a.preventDefault()},_mouseDistanceMet:function(a){return Math.max(Math.abs(this._mouseDownEvent.pageX-a.pageX),Math.abs(this._mouseDownEvent.pageY-
...
drag:function(a,b,c){var f,e,g,h,k,l,m,n,p,q,u=c.options,t=u.snapTolerance,r=b.offset.left,w=r+c.helperProportions.width,y=b.offset.top,v=y+c.helperProportions.height;for(p=c.snapElements.length-1;0<=p;p--)k=c.snapElements[p].left-c.margins.left,l=k+c.snapElements[p].width,m=c.snapElements[p].top-c.margins.top,n=m+c.snapElements[p].height,w<k-t||r>l+t||v<m-t||y>n+t||!d.contains(c.snapElements[p].item.ownerDocument,c.snapElements[p].item)?(c.snapElements[p].snapping&&c.options.snap.release&&c.options.snap.release.call(c.element,
a,d.extend(c._uiHash(),{snapItem:c.snapElements[p].item})),c.snapElements[p].snapping=!1):("inner"!==u.snapMode&&(f=Math.abs(m-v)<=t,e=Math.abs(n-y)<=t,g=Math.abs(k-w)<=t,h=Math.abs(l-r)<=t,f&&(b.position.top=c._convertPositionTo("relative",{top:m-c.helperProportions.height,left:0}).top),e&&(b.position.top=c._convertPositionTo("relative",{top:n,left:0}).top),g&&(b.position.left=c._convertPositionTo("relative",{top:0,left:k-c.helperProportions.width}).left),h&&(b.position.left=c._convertPositionTo("relative",
{top:0,left:l}).left)),q=f||e||g||h,"outer"!==u.snapMode&&(f=Math.abs(m-y)<=t,e=Math.abs(n-v)<=t,g=Math.abs(k-r)<=t,h=Math.abs(l-w)<=t,f&&(b.position.top=c._convertPositionTo("relative",{top:m,left:0}).top),e&&(b.position.top=c._convertPositionTo("relative",{top:n-c.helperProportions.height,left:0}).top),g&&(b.position.left=c._convertPositionTo("relative",{top:0,left:k}).left),h&&(b.position.left=c._convertPositionTo("relative",{top:0,left:l-c.helperProportions.width}).left)),!c.snapElements[p].snapping&&
...
this.elementIsWrapper&&(b(this.element),a=this.element,this.originalElement.css({position:a.css("position"),width:a.outerWidth(),height:a.outerHeight(),top:a.css("top"),left:a.css("left")}).insertAfter(a),a.remove());this.originalElement.css("resize",this.originalResizeStyle);b(this.originalElement);return this},_setOption:function(a,b){this._super(a,b);switch(a){case "handles":this._removeHandles(),this._setupHandles()}},_setupHandles:function(){var a=this.options,b,c,f,e,g,h=this;this.handles=a.handles||
(d(".ui-resizable-handle",this.element).length?{n:".ui-resizable-n",e:".ui-resizable-e",s:".ui-resizable-s",w:".ui-resizable-w",se:".ui-resizable-se",sw:".ui-resizable-sw",ne:".ui-resizable-ne",nw:".ui-resizable-nw"}:"e,s,se");this._handles=d();if(this.handles.constructor===String)for("all"===this.handles&&(this.handles="n,e,s,w,se,sw,ne,nw"),f=this.handles.split(","),this.handles={},c=0;c<f.length;c++)b=d.trim(f[c]),e="ui-resizable-"+b,g=d("<div>"),this._addClass(g,"ui-resizable-handle "+e),g.css({zIndex:a.zIndex}),
...
_propagate:function(a,b){d.ui.plugin.call(this,a,[b,this.ui()]);"resize"!==a&&this._trigger(a,b,this.ui())},plugins:{},ui:function(){return{originalElement:this.originalElement,element:this.element,helper:this.helper,position:this.position,size:this.size,originalSize:this.originalSize,originalPosition:this.originalPosition}}});d.ui.plugin.add("resizable","animate",{stop:function(a){var b=d(this).resizable("instance"),c=b.options,f=b._proportionallyResizeElements,e=f.length&&/textarea/i.test(f[0].nodeName),
g=e&&b._hasScroll(f[0],"left")?0:b.sizeDiff.height,e={width:b.size.width-(e?0:b.sizeDiff.width),height:b.size.height-g},g=parseFloat(b.element.css("left"))+(b.position.left-b.originalPosition.left)||null,h=parseFloat(b.element.css("top"))+(b.position.top-b.originalPosition.top)||null;b.element.animate(d.extend(e,h&&g?{top:h,left:g}:{}),{duration:c.animateDuration,easing:c.animateEasing,step:function(){var c={width:parseFloat(b.element.css("width")),height:parseFloat(b.element.css("height")),top:parseFloat(b.element.css("top")),
left:parseFloat(b.element.css("left"))};f&&f.length&&d(f[0]).css({width:c.width,height:c.height});b._updateCache(c);b._propagate("resize",a)}})}});d.ui.plugin.add("resizable","containment",{start:function(){var a,b,c,f,e,g=d(this).resizable("instance"),h=g.element;c=g.options.containment;if(h=c instanceof d?c.get(0):/parent/.test(c)?h.parent().get(0):c)g.containerElement=d(h),/document/.test(c)||c===document?(g.containerOffset={left:0,top:0},g.containerPosition={left:0,top:0},g.parentData={element:d(document),
...
b=d(this).resizable("instance"),c=b.options,f=b.size,e=b.originalSize,g=b.originalPosition,h=b.axis,k="number"===typeof c.grid?[c.grid,c.grid]:c.grid,l=k[0]||1,m=k[1]||1,n=Math.round((f.width-e.width)/l)*l,f=Math.round((f.height-e.height)/m)*m,p=e.width+n,q=e.height+f,u=c.maxWidth&&c.maxWidth<p,t=c.maxHeight&&c.maxHeight<q,r=c.minWidth&&c.minWidth>p,w=c.minHeight&&c.minHeight>q;c.grid=k;r&&(p+=l);w&&(q+=m);u&&(p-=l);t&&(q-=m);if(/^(se|s|e)$/.test(h))b.size.width=p,b.size.height=q;else if(/^(ne)$/.test(h))b.size.width=
p,b.size.height=q,b.position.top=g.top-f;else if(/^(sw)$/.test(h))b.size.width=p,b.size.height=q,b.position.left=g.left-n;else{if(0>=q-m||0>=p-l)a=b._getPaddingPlusBorderDimensions(this);0<q-m?(b.size.height=q,b.position.top=g.top-f):(q=m-a.height,b.size.height=q,b.position.top=g.top+e.height-q);0<p-l?(b.size.width=p,b.position.left=g.left-n):(p=l-a.width,b.size.width=p,b.position.left=g.left+e.width-p)}}});d.widget("ui.dialog",{version:"1.12.0",options:{appendTo:"body",autoOpen:!0,buttons:[],classes:{"ui-dialog":"ui-corner-all",
...
this._focusTabbable()}});this.element.find("[aria-describedby]").length||this.uiDialog.attr({"aria-describedby":this.element.uniqueId().attr("id")})},_createTitlebar:function(){var a;this.uiDialogTitlebar=d("<div>");this._addClass(this.uiDialogTitlebar,"ui-dialog-titlebar","ui-widget-header ui-helper-clearfix");this._on(this.uiDialogTitlebar,{mousedown:function(a){d(a.target).closest(".ui-dialog-titlebar-close")||this.uiDialog.trigger("focus")}});this.uiDialogTitlebarClose=d("<button type='button'></button>").button({label:d("<a>").text(this.options.closeText).html(),
...
"ui-dialog-buttons"):(d.each(b,function(b,f){var e,g;f=d.isFunction(f)?{click:f,text:b}:f;f=d.extend({type:"button"},f);e=f.click;g={icon:f.icon,iconPosition:f.iconPosition,showLabel:f.showLabel};delete f.click;delete f.icon;delete f.iconPosition;delete f.showLabel;d("<button></button>",f).button(g).appendTo(a.uiButtonSet).on("click",function(){e.apply(a.element[0],arguments)})}),this._addClass(this.uiDialog,"ui-dialog-buttons"),this.uiDialogButtonPane.appendTo(this.uiDialog))},_makeDraggable:function(){function a(a){return{position:a.position,
...
d.ui.ddmanager.prepareOffsets(a,b);d.each(d.ui.ddmanager.droppables[a.options.scope]||[],function(){if(!this.options.disabled&&!this.greedyChild&&this.visible){var c,f,e;e=O(a,this,this.options.tolerance,b);var g=!e&&this.isover?"isout":e&&!this.isover?"isover":null;g&&(this.options.greedy&&(f=this.options.scope,e=this.element.parents(":data(ui-droppable)").filter(function(){return d(this).droppable("instance").options.scope===f}),e.length&&(c=d(e[0]).droppable("instance"),c.greedyChild="isover"===
...
c.selected=!1,b._addClass(c.$element,"ui-unselecting"),c.unselecting=!0,b._trigger("unselecting",a,{unselecting:c.element}))}),d(a.target).parents().addBack().each(function(){var c,e=d.data(this,"selectable-item");if(e)return c=!a.metaKey&&!a.ctrlKey||!e.$element.hasClass("ui-selected"),b._removeClass(e.$element,c?"ui-unselecting":"ui-selected")._addClass(e.$element,c?"ui-selecting":"ui-unselecting"),e.unselecting=!c,e.selecting=c,(e.selected=c)?b._trigger("selecting",a,{selecting:e.element}):b._trigger("unselecting",
a,{unselecting:e.element}),!1}))},_mouseDrag:function(a){this.dragged=!0;if(!this.options.disabled){var b,c=this,f=this.options,e=this.opos[0],g=this.opos[1],h=a.pageX,k=a.pageY;e>h&&(b=h,h=e,e=b);g>k&&(b=k,k=g,g=b);this.helper.css({left:e,top:g,width:h-e,height:k-g});this.selectees.each(function(){var b=d.data(this,"selectable-item"),m=!1,n,p,q,u;b&&b.element!==c.element[0]&&(n=b.left+c.elementPos.left,p=b.right+c.elementPos.left,q=b.top+c.elementPos.top,u=b.bottom+c.elementPos.top,"touch"===f.tolerance?
m=!(n>h||p<e||q>k||u<g):"fit"===f.tolerance&&(m=n>e&&p<h&&q>g&&u<k),m?(b.selected&&(c._removeClass(b.$element,"ui-selected"),b.selected=!1),b.unselecting&&(c._removeClass(b.$element,"ui-unselecting"),b.unselecting=!1),b.selecting||(c._addClass(b.$element,"ui-selecting"),b.selecting=!0,c._trigger("selecting",a,{selecting:b.element}))):(b.selecting&&((a.metaKey||a.ctrlKey)&&b.startselected?(c._removeClass(b.$element,"ui-selecting"),b.selecting=!1,c._addClass(b.$element,"ui-selected"),b.selected=!0):
...
d.data(this,"selectable-item");b._removeClass(c.$element,"ui-unselecting");c.unselecting=!1;c.startselected=!1;b._trigger("unselected",a,{unselected:c.element})});d(".ui-selecting",this.element[0]).each(function(){var c=d.data(this,"selectable-item");b._removeClass(c.$element,"ui-selecting")._addClass(c.$element,"ui-selected");c.selecting=!1;c.selected=!0;c.startselected=!0;b._trigger("selected",a,{selected:c.element})});this._trigger("stop",a);this.helper.remove();return!1}});d.widget("ui.selectmenu",
...
this._bindFormResetHandler();this._rendered=!1;this.menuItems=d()},_drawButton:function(){var a,b=this,c=this._parseOption(this.element.find("option:selected"),this.element[0].selectedIndex);this.labels=this.element.labels().attr("for",this.ids.button);this._on(this.labels,{click:function(a){this.button.focus();a.preventDefault()}});this.element.hide();this.button=d("<span>",{tabindex:this.options.disabled?-1:0,id:this.ids.button,role:"combobox","aria-expanded":"false","aria-autocomplete":"list",
"aria-owns":this.ids.menu,"aria-haspopup":"true",title:this.element.attr("title")}).insertAfter(this.element);this._addClass(this.button,"ui-selectmenu-button ui-selectmenu-button-closed","ui-button ui-widget");a=d("<span>").appendTo(this.button);this._addClass(a,"ui-selectmenu-icon","ui-icon "+this.options.icons.button);this.buttonItem=this._renderButtonItem(c).appendTo(this.button);!1!==this.options.width&&this._resizeButton();this._on(this.button,this._buttonEvents);this.button.one("focusin",function(){b._rendered||
b._refreshMenu()})},_drawMenu:function(){var a=this;this.menu=d("<ul>",{"aria-hidden":"true","aria-labelledby":this.ids.button,id:this.ids.menu});this.menuWrap=d("<div>").append(this.menu);this._addClass(this.menuWrap,"ui-selectmenu-menu","ui-front");this.menuWrap.appendTo(this._appendTo());this.menuInstance=this.menu.menu({classes:{"ui-menu":"ui-corner-bottom"},role:"listbox",select:function(b,c){b.preventDefault();a._setSelection();a._select(c.item.data("ui-selectmenu-item"),b)},focus:function(b,
...
this.options.position))},close:function(a){this.isOpen&&(this.isOpen=!1,this._toggleAttr(),this.range=null,this._off(this.document),this._trigger("close",a))},widget:function(){return this.button},menuWidget:function(){return this.menu},_renderButtonItem:function(a){var b=d("<span>");this._setText(b,a.label);this._addClass(b,"ui-selectmenu-text");return b},_renderMenu:function(a,b){var c=this,f="";d.each(b,function(b,g){var h;g.optgroup!==f&&(h=d("<li>",{text:g.optgroup}),c._addClass(h,"ui-selectmenu-optgroup",
...
b;a=this.options;var c=this.element.find(".ui-slider-handle"),f=[];b=a.values&&a.values.length||1;c.length>b&&(c.slice(b).remove(),c=c.slice(0,b));for(a=c.length;a<b;a++)f.push("<span tabindex='0'></span>");this.handles=c.add(d(f.join("")).appendTo(this.element));this._addClass(this.handles,"ui-slider-handle","ui-state-default");this.handle=this.handles.eq(0);this.handles.each(function(a){d(this).data("ui-slider-handle-index",a)})},_createRange:function(){var a=this.options;a.range?(!0===a.range&&
(a.values?a.values.length&&2!==a.values.length?a.values=[a.values[0],a.values[0]]:d.isArray(a.values)&&(a.values=a.values.slice(0)):a.values=[this._valueMin(),this._valueMin()]),this.range&&this.range.length?(this._removeClass(this.range,"ui-slider-range-min ui-slider-range-max"),this.range.css({left:"",bottom:""})):(this.range=d("<div>").appendTo(this.element),this._addClass(this.range,"ui-slider-range")),"min"!==a.range&&"max"!==a.range||this._addClass(this.range,"ui-slider-range-"+a.range)):(this.range&&
...
"%"},h.animate);if("max"===g&&"vertical"===this.orientation)this.range.stop(1,1)[l?"animate":"css"]({height:100-b+"%"},h.animate)}},_handleEvents:{keydown:function(a){var b,c,f,e=d(a.target).data("ui-slider-handle-index");switch(a.keyCode){case d.ui.keyCode.HOME:case d.ui.keyCode.END:case d.ui.keyCode.PAGE_UP:case d.ui.keyCode.PAGE_DOWN:case d.ui.keyCode.UP:case d.ui.keyCode.RIGHT:case d.ui.keyCode.DOWN:case d.ui.keyCode.LEFT:if(a.preventDefault(),!this._keySliding&&(this._keySliding=!0,this._addClass(d(a.target),
...
this);d.ui.ddmanager&&!b.dropBehaviour&&d.ui.ddmanager.prepareOffsets(this,a);this.dragging=!0;this._addClass(this.helper,"ui-sortable-helper");this._mouseDrag(a);return!0},_mouseDrag:function(a){var b,c,f,e;b=this.options;c=!1;this.position=this._generatePosition(a);this.positionAbs=this._convertPositionTo("absolute");this.lastPositionAbs||(this.lastPositionAbs=this.positionAbs);this.options.scroll&&(this.scrollParent[0]!==this.document[0]&&"HTML"!==this.scrollParent[0].tagName?(this.overflowOffset.top+
...
this.positionAbs.left,c=b+this.helperProportions.width,d=this.positionAbs.top,e=d+this.helperProportions.height,g=a.left,h=g+a.width,k=a.top,l=k+a.height,m=this.offset.click.top,n=this.offset.click.left,m="x"===this.options.axis||d+m>k&&d+m<l,n="y"===this.options.axis||b+n>g&&b+n<h;return"pointer"===this.options.tolerance||this.options.forcePointerForContainers||"pointer"!==this.options.tolerance&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?m&&n:g<b+this.helperProportions.width/
2&&c-this.helperProportions.width/2<h&&k<d+this.helperProportions.height/2&&e-this.helperProportions.height/2<l},_intersectsWithPointer:function(a){var b;b="x"===this.options.axis||this._isOverAxis(this.positionAbs.top+this.offset.click.top,a.top,a.height);a="y"===this.options.axis||this._isOverAxis(this.positionAbs.left+this.offset.click.left,a.left,a.width);if(!b||!a)return!1;b=this._getDragVerticalDirection();a=this._getDragHorizontalDirection();return this.floating?"right"===a||"down"===b?2:1:
...
this.currentItem[0]&&(h=this.items[c].item.offset()[e],k=!1,a[l]-h>this.items[c][g]/2&&(k=!0),Math.abs(a[l]-h)<b&&(b=Math.abs(a[l]-h),f=this.items[c],this.direction=k?"up":"down"));if(f||this.options.dropOnEmpty)this.currentContainer===this.containers[m]?this.currentContainer.containerCache.over||(this.containers[m]._trigger("over",a,this._uiHash()),this.currentContainer.containerCache.over=1):(f?this._rearrange(a,f,null,!0):this._rearrange(a,null,this.containers[m].element,!0),this._trigger("change",
a,this._uiHash()),this.containers[m]._trigger("change",a,this._uiHash(this)),this.currentContainer=this.containers[m],this.options.placeholder.update(this.currentContainer,this.placeholder),this.containers[m]._trigger("over",a,this._uiHash(this)),this.containers[m].containerCache.over=1)}},_createHelper:function(a){var b=this.options;a=d.isFunction(b.helper)?d(b.helper.apply(this.element[0],[a,this.currentItem])):"clone"===b.helper?this.currentItem.clone():this.currentItem;a.parents("body").length||
...
this.scrollParent[0]!==this.document[0]&&d.contains(this.scrollParent[0],this.offsetParent[0])&&(a.left+=this.scrollParent.scrollLeft(),a.top+=this.scrollParent.scrollTop());if(this.offsetParent[0]===this.document[0].body||this.offsetParent[0].tagName&&"html"===this.offsetParent[0].tagName.toLowerCase()&&d.ui.ie)a={top:0,left:0};return{top:a.top+(parseInt(this.offsetParent.css("borderTopWidth"),10)||0),left:a.left+(parseInt(this.offsetParent.css("borderLeftWidth"),10)||0)}},_getRelativeOffset:function(){if("relative"===
...
_setContainment:function(){var a,b,c;b=this.options;"parent"===b.containment&&(b.containment=this.helper[0].parentNode);if("document"===b.containment||"window"===b.containment)this.containment=[0-this.offset.relative.left-this.offset.parent.left,0-this.offset.relative.top-this.offset.parent.top,"document"===b.containment?this.document.width():this.window.width()-this.helperProportions.width-this.margins.left,("document"===b.containment?this.document.height()||document.body.parentNode.scrollHeight:
...
_increment:function(a){var b=this.options.incremental;return b?d.isFunction(b)?b(a):Math.floor(a*a*a/5E4-a*a/500+17*a/200+1):1},_precision:function(){var a=this._precisionOf(this.options.step);null!==this.options.min&&(a=Math.max(a,this._precisionOf(this.options.min)));return a},_precisionOf:function(a){a=a.toString();var b=a.indexOf(".");return-1===b?0:a.length-b-1},_adjustValue:function(a){var b,c=this.options;b=null!==c.min?c.min:0;a=b+Math.round((a-b)/c.step)*c.step;a=parseFloat(a.toFixed(this._precision()));
...
null,this.options.icons.up),this._addClass(c,null,b.up),c=this.buttons.last().find(".ui-icon"),this._removeClass(c,null,this.options.icons.down),this._addClass(c,null,b.down)),this._super(a,b))},_setOptionDisabled:function(a){this._super(a);this._toggleClass(this.uiSpinner,null,"ui-state-disabled",!!a);this.element.prop("disabled",!!a);this.buttons.button(a?"disable":"enable")},_setOptions:E(function(a){this._super(a)}),_parse:function(a){"string"===typeof a&&""!==a&&(a=window.Globalize&&this.options.numberFormat?
...
a&&(c=this._parse(a),null!==c&&(b||(c=this._adjustValue(c)),a=this._format(c)));this.element.val(a);this._refresh()},_destroy:function(){this.element.prop("disabled",!1).removeAttr("autocomplete role aria-valuemin aria-valuemax aria-valuenow");this.uiSpinner.replaceWith(this.element)},stepUp:E(function(a){this._stepUp(a)}),_stepUp:function(a){this._start()&&(this._spin((a||1)*this.options.step),this._stop())},stepDown:E(function(a){this._stepDown(a)}),_stepDown:function(a){this._start()&&(this._spin((a||
1)*-this.options.step),this._stop())},pageUp:E(function(a){this._stepUp((a||1)*this.options.page)}),pageDown:E(function(a){this._stepDown((a||1)*this.options.page)}),value:function(a){if(!arguments.length)return this._parse(this.element.val());E(this._value).call(this,a)},widget:function(){return this.uiSpinner}});!1!==d.uiBackCompat&&d.widget("ui.spinner",d.ui.spinner,{_enhance:function(){this.uiSpinner=this.element.attr("autocomplete","off").wrap(this._uiSpinnerHtml()).parent().append(this._buttonHtml())},
_uiSpinnerHtml:function(){return"<span>"},_buttonHtml:function(){return"<a></a><a></a>"}});d.widget("ui.tabs",{version:"1.12.0",delay:300,options:{active:null,classes:{"ui-tabs":"ui-corner-all","ui-tabs-nav":"ui-corner-all","ui-tabs-panel":"ui-corner-bottom","ui-tabs-tab":"ui-corner-top"},collapsible:!1,event:"click",heightStyle:"content",hide:null,show:null,activate:null,beforeActivate:null,beforeLoad:null,load:null},_isLocal:function(){var a=/#.*$/;return function(b){var c,d;c=b.href.replace(a,
...
this.active=!1!==this.options.active&&this.anchors.length?this._findActive(b.active):d();this._refresh();this.active.length&&this.load(b.active)},_initialActive:function(){var a=this.options.active,b=this.options.collapsible,c=location.hash.substring(1);null===a&&(c&&this.tabs.each(function(b,e){if(d(e).attr("aria-controls")===c)return a=b,!1}),null===a&&(a=this.tabs.index(this.tabs.filter(".ui-tabs-active"))),null===a||-1===a)&&(a=this.tabs.length?0:!1);!1!==a&&(a=this.tabs.index(this.tabs.eq(a)),
-1===a&&(a=b?!1:0));!b&&!1===a&&this.anchors.length&&(a=0);return a},_getCreateEventData:function(){return{tab:this.active,panel:this.active.length?this._getPanelForTab(this.active):d()}},_tabKeydown:function(a){var b=d(d.ui.safeActiveElement(this.document[0])).closest("li"),c=this.tabs.index(b),f=!0;if(!this._handlePageNav(a)){switch(a.keyCode){case d.ui.keyCode.RIGHT:case d.ui.keyCode.DOWN:c++;break;case d.ui.keyCode.UP:case d.ui.keyCode.LEFT:f=!1;c--;break;case d.ui.keyCode.END:c=this.anchors.length-
...
this.tabs=this.tablist.find("> li:has(a[href])").attr({role:"tab",tabIndex:-1});this._addClass(this.tabs,"ui-tabs-tab","ui-state-default");this.anchors=this.tabs.map(function(){return d("a",this)[0]}).attr({role:"presentation",tabIndex:-1});this._addClass(this.anchors,"ui-tabs-anchor");this.panels=d();this.anchors.each(function(b,c){var f,k,l=d(c).uniqueId().attr("id"),m=d(c).closest("li"),n=m.attr("aria-controls");a._isLocal(c)?(f=c.hash,k=f.substring(1),f=a.element.find(a._sanitizeSelector(f))):
(k=m.attr("aria-controls")||d({}).uniqueId()[0].id,f=a.element.find("#"+k),f.length||(f=a._createPanel(k),f.insertAfter(a.panels[b-1]||a.tablist)),f.attr("aria-live","polite"));f.length&&(a.panels=a.panels.add(f));n&&m.data("ui-tabs-aria-controls",n);m.attr({"aria-controls":k,"aria-labelledby":l});f.attr("aria-labelledby",l)});this.panels.attr("role","tabpanel");this._addClass(this.panels,"ui-tabs-panel","ui-widget-content");b&&(this._off(b.not(this.tabs)),this._off(c.not(this.anchors)),this._off(f.not(this.panels)))},
...
"")},enable:function(a){var b=this.options.disabled;!1!==b&&(void 0===a?b=!1:(a=this._getIndex(a),b=d.isArray(b)?d.map(b,function(b){return b!==a?b:null}):d.map(this.tabs,function(b,d){return d!==a?d:null})),this._setOptionDisabled(b))},disable:function(a){var b=this.options.disabled;if(!0!==b){if(void 0===a)b=!0;else{a=this._getIndex(a);if(-1!==d.inArray(a,b))return;b=d.isArray(b)?d.merge([a],b).sort():[a]}this._setOptionDisabled(b)}},load:function(a,b){a=this._getIndex(a);var c=this,f=this.tabs.eq(a),
e=f.find(".ui-tabs-anchor"),g=this._getPanelForTab(f),h={tab:f,panel:g},k=function(a,b){"abort"===b&&c.panels.stop(!1,!0);c._removeClass(f,"ui-tabs-loading");g.removeAttr("aria-busy");a===c.xhr&&delete c.xhr};this._isLocal(e[0])||(this.xhr=d.ajax(this._ajaxSettings(e,b,h)))&&"canceled"!==this.xhr.statusText&&(this._addClass(f,"ui-tabs-loading"),g.attr("aria-busy","true"),this.xhr.done(function(a,d,e){setTimeout(function(){g.html(a);c._trigger("load",b,h);k(e,d)},1)}).fail(function(a,b){setTimeout(function(){k(a,
...
b){var c={keyup:function(a){a.keyCode===d.ui.keyCode.ESCAPE&&(a=d.Event(a),a.currentTarget=b[0],this.close(a,!0))}};b[0]!==this.element[0]&&(c.remove=function(){this._removeTooltip(this._find(b).tooltip)});a&&"mouseover"!==a.type||(c.mouseleave="close");a&&"focusin"!==a.type||(c.focusout="close");this._on(!0,b,c)},close:function(a){var b,c=this,f=d(a?a.currentTarget:this.element),e=this._find(f);e?(b=e.tooltip,e.closing||(clearInterval(this.delayedShow),f.data("ui-tooltip-title")&&!f.attr("title")&&
